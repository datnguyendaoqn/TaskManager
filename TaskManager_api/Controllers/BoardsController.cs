...
namespace TaskManager_api.Controllers
{
    ...
    public class BoardsController : ControllerBase
    {
        ...
        public async Task<IActionResult> CreateBoard([FromRoute] int projectId, [FromBody] BoardCreateDTO dto)
        {
        ...
        ///<summary>
        /// Lấy infor chi tiết 1 board 
        ///</summary>

        [HttpGet("boards/{boardId}")]
        public async Task<IActionResult> GetBoardDetail([FromRoute] int boardId, [FromQuery] bool includeArchived = false)
        {
        ...
        [HttpGet("boards/{projectId}/archived")]
        ...
        public async Task<IActionResult> GetBoardsOfProject([FromRoute]int projectId, [FromQuery] bool includeArchived = false)
        {
        ...
        /// Archive board
        /// </summary>
        [HttpPatch("boards/{boardId}/archive")]
        ...
        /// Unarchive board
        /// </summary>
        [HttpPatch("boards/{boardId}/unarchive")]
